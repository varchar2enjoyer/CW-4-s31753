...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(emp => depts.Any(dept => dept.Loc == "CHICAGO" && dept.DeptNo == emp.DeptNo)).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        Assert.Contains(result, g => g.DeptNo == 30 && g.EmployeeCount == 2);
    }
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(emp => emp.Comm != null).Select(emp => new { emp.EName, emp.Comm }); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .SelectMany(emp => grades
                .Where(g => g.Losal <= emp.Sal && emp.Sal <= g.Hisal)
                .Select(g => new { emp.EName, g.Grade }));
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(emp => emp.DeptNo).Select(g => new { DeptNo = g.Key, AvgSal = g.Average(sal => sal.Sal) });
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).SelectMany(g =>
            {
